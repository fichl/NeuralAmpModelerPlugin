...
{
  IControl* l_oUpArrow = lGraphics->GetControlWithTag(251); // kCtrlTagNAMNavDown = NAM up arrow
  l_oUpArrow->Hide(false);
  IControl* l_oDownArrow = lGraphics->GetControlWithTag(250); // kCtrlTagNAMNavUp = NAM down arrow
...
{
  IControl* l_oUpArrow = lGraphics->GetControlWithTag(252); // kCtrlTagIRNavUp = IR up arrow
  l_oUpArrow->Hide(false);
  IControl* l_oDownArrow = lGraphics->GetControlWithTag(253); // kCtrlTagIRNavDown = IR down arrow
  l_oDownArrow->Hide(false);
}
